...
const App = () => {
  ...
  return (
    <div>
      <motion.div style={{ scaleX: scrollYProgress, background: "red", width: "100%", position: 'fixed', top: "0", height: "4px" , transformOrigin : "left" }}></motion.div>
      <div>
        <h4>Testing the scroll animations</h4>
      </div>
      <div>
